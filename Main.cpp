...
void Main::help_mode(){
    std::cout << "Help Mode\n"
                 "FILE TEST MODE\n"
                 "\tUsage:\n"
                 "\t./aizog --file <problem> <algorithm> <inputFile> <outputFile> [startNode] [endNode]\n"
                 ...
                 "\t[startNode]\tStarting Node (usable only in Shortest Path algorithms)\n"
                 "\t[endNode]\tEnding Node (usable only in Shortest Path algorithms)\n"
                 "BENCHMARK MODE\n"
                 "\tUsage:\n"
                 "\t./aizog --test <problem> <algorithm> <number_of_nodes> <density> <iterations> <outputFile> [startNode] [endNode]\n"
                 "\t<problem>\tProblem to be solved:\n"
                 "\t\t0 - Minimum Spanning Tree\n"
                 "\t\t1 - Shortest Path in Graph\n"
                 "\t<algorithm>\tChosen algorithm: 0-Prim/Dijkstra, 1-Kruskal/Bellman\n"
